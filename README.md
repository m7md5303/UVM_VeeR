# UVM_VeeR
UVM Environment for verifying the **Veer RISC-V-Based Core** 'https://github.com/chipsalliance/Cores-VeeR-EH1/tree/main' . It levarages the usage of a mix of constrained randomization, concurrent and immediate assertions as well as having the support of well-built coverage groups
